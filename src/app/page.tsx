  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <header className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-2">Resume Tailor</h1>
        <p className="text-gray-600">AI-powered resume optimization for your dream job</p>
      </header>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Your Resume
              <span className="text-xs text-gray-500 ml-2">(Upload a PDF or paste your resume text)</span>
            </label>
            
            <div className="mb-4">
              <div {...getRootProps()} className={`flex items-center justify-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer ${
        ...
        {error && (
          <div className="mt-6 p-4 bg-red-50 text-red-700 rounded-md flex items-center">
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {comparison && (
          <div className="mt-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Review Changes</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border rounded-lg p-4">
                <h4 className="font-medium text-gray-700 mb-2">Original Resume</h4>
                <div className="prose max-w-none" dangerouslySetInnerHTML={{ __html: comparison.original }} />
              </div>
              <div className="border rounded-lg p-4">
                <h4 className="font-medium text-gray-700 mb-2">Tailored Resume</h4>
                <div className="prose max-w-none" dangerouslySetInnerHTML={{ __html: comparison.tailored }} />
              </div>
            </div>
